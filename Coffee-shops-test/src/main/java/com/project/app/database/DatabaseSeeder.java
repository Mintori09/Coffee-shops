...
public class DatabaseSeeder {
    ...
    private void seedDrinks() {
        ...
        // Assuming drink_category_id is an integer in the database
    ...
    private void seedAccounts() throws SQLException {
        ...
        Account account1 = new Account(1, "a", "1", "admin");
        Account account2 = new Account(2, "b", "2", "employee");
    ...
    private void seedEmployees() {
        ...
        Employee employee1 = new Employee(1, "Nguyen Van A", LocalDate.of(1990, 5, 15), "Male", "0123456789", LocalDateTime.now(), 1);
        Employee employee2 = new Employee(2, "Tran Thi B", LocalDate.of(1992, 8, 20), "Female", "0987654321", LocalDateTime.now(), 2);
