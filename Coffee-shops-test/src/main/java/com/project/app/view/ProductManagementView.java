...
public class ProductManagementView extends JPanel {
    ...
    private JPanel createButtonPanel() {
        ...
        addButton = createStyledButton("Thêm", new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/icon/add_icon.png"))));
        updateButton = createStyledButton("Cập nhật", new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/icon/edit_icon.png"))));
        deleteButton = createStyledButton("Xóa", new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/icon/delete_icon.png"))));
