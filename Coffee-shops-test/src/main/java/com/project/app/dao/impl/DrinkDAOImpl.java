...
public class DrinkDAOImpl implements DrinkDAO {
    ...
    public boolean create(Drink drink) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setInt(2, drink.getDrinkCategoryId()); // Assuming getDrinkCategoryId() is the correct getter for drinkCategoryId
    ...
    public Drink findById(int drinkId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                drink.setDrinkCategoryId(rs.getInt("drink_category_id")); // Assuming setter takes String
    ...
    public void deleteAll() throws SQLException {
        ...
        String resetSql = "ALTER TABLE drinks AUTO_INCREMENT = 1";
